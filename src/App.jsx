...
const AnimatedBackground = () => {
  const squares = Array.from({ length: 15 }).map((_, i) => ({
    size: Math.random() * 100 + 20, // Random size between 20px and 120px
    initialX: Math.random() * 100, // Random X position
    initialY: Math.random() * 100 + 100, // Start below the viewport
  ...
  return (
    <div className="relative min-h-screen bg-black">
      ...
      <div className="relative z-10 min-h-screen text-white">
        {/* Navigation */}
        <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 bg-black/80 backdrop-blur-sm rounded-full px-6 py-2 border border-gray-600">
